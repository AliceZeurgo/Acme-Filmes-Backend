...
const ERROR_INTERNAL_SERVER = {status: false, status_code: 500, message: 'Ocorreram erros internos no servidos na camada de negocio da API, por favor contate o desenvolvedor'}
